...
extern bpf_map_def known_traces;
extern bpf_map_def per_cpu_records;
extern bpf_map_def per_cpu_frame_list;
extern bpf_map_def hash_to_count;
extern bpf_map_def hash_to_trace;
extern bpf_map_def hash_to_framelist;
extern bpf_map_def pid_page_to_mapping_info;
extern bpf_map_def metrics;
extern bpf_map_def report_pid_events;
