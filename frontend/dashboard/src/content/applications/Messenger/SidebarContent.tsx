...
function SidebarContent() {
  const user = {
    name: 'Catherine Pike',
    avatar: process.env.PUBLIC_URL + '/static/images/avatars/1.jpg',
        ...
        {currentTab === 'all' && (
          <List disablePadding component="div">
            <ListItemWrapper selected>
              <ListItemAvatar>
                <Avatar src={process.env.PUBLIC_URL + "/static/images/avatars/1.jpg"} />
              </ListItemAvatar>
              <ListItemText
                sx={{
                  mr: 1
            ...
            <ListItemWrapper>
              <ListItemAvatar>
                <Avatar src={process.env.PUBLIC_URL + "/static/images/avatars/2.jpg"} />
              </ListItemAvatar>
              <ListItemText
                sx={{
                  mr: 1
            ...
            <ListItemWrapper>
              <ListItemAvatar>
                <Avatar src={process.env.PUBLIC_URL + "/static/images/avatars/3.jpg"} />
              </ListItemAvatar>
              <ListItemText
                sx={{
                  mr: 1
            ...
            <ListItemWrapper>
              <ListItemAvatar>
                <Avatar src={process.env.PUBLIC_URL + "/static/images/avatars/4.jpg"} />
              </ListItemAvatar>
              <ListItemText
                sx={{
                  mr: 1
          ...
          <AvatarGroup>
            <Tooltip arrow title="View profile for Remy Sharp">
              <Avatar
                ...
                to="#"
                alt="Remy Sharp"
                src={process.env.PUBLIC_URL + "/static/images/avatars/1.jpg"}
              />
            </Tooltip>
            <Tooltip arrow title="View profile for Travis Howard">
              <Avatar
                ...
                to="#"
                alt="Travis Howard"
                src={process.env.PUBLIC_URL + "/static/images/avatars/2.jpg"}
              />
            </Tooltip>
            <Tooltip arrow title="View profile for Craig Vaccaro">
              <Avatar
                ...
                to="#"
                alt="Craig Vaccaro"
                src={process.env.PUBLIC_URL + "/static/images/avatars/3.jpg"}
              />
            </Tooltip>
          </AvatarGroup>
          ...
          <AvatarGroup>
            <Tooltip arrow title="View profile for Travis Howard">
              <Avatar
                ...
                to="#"
                alt="Travis Howard"
                src={process.env.PUBLIC_URL + "/static/images/avatars/4.jpg"}
              />
            </Tooltip>
            <Tooltip arrow title="View profile for Craig Vaccaro">
              <Avatar
                ...
                to="#"
                alt="Craig Vaccaro"
                src={process.env.PUBLIC_URL + "/static/images/avatars/5.jpg"}
              />
            </Tooltip>
          </AvatarGroup>
